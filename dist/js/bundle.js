...
function scrollView() {
  var chartIntAt = window.pageYOffset + window.innerHeight - chartBoxEl.offsetHeight / 10;
  var chartBottom = chartBoxEl.offsetTop + chartBoxEl.offsetHeight;
  var isHalfShown = chartIntAt > chartBoxEl.offsetTop;
  var isNotScrolledPast = window.pageYOffset < chartBottom; // view chart
...
window.addEventListener('scroll', Object(_throttle_js__WEBPACK_IMPORTED_MODULE_1__["throttle"])(scrollView, 500)); // show scroll button
...
window.addEventListener('scroll', Object(_throttle_js__WEBPACK_IMPORTED_MODULE_1__["throttle"])(showScrollBtn, 1000)); // swiper
...
function getNews() {
  for (var i = 0; i < _news_js__WEBPACK_IMPORTED_MODULE_2__["news"].length; i++) {
    ...
    imgEl.setAttribute('src', _news_js__WEBPACK_IMPORTED_MODULE_2__["news"][i].img);
    imgEl.classList.add('swiper-lazy');
    textEl.innerText = _news_js__WEBPACK_IMPORTED_MODULE_2__["news"][i].text;
...
var news = [{
  link: "https://news.naver.com/main/read.nhn?mode=LSD&mid=sec&sid1=101&oid=008&aid=0004392596",
  img: "https://imgnews.pstatic.net/image/008/2020/04/10/0004392596_001_20200410123402605.jpg?type=w647",
  text: "'마이풀 영중토' 원스토어와 업무협약…국내 최초 영어·중국어·토익 월구독 서비스"
}, {
  link: "https://www.mrepublic.co.kr/news/articleView.html?idxno=43052",
  img: "https://www.mrepublic.co.kr/news/photo/202003/43052_60938_837.jpg",
  text: "이카이스, 글로벌 어학 플랫폼 ‘마이풀’ 한국어 서비스 공개"
}, {
